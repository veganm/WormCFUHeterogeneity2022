...
# Simulation-Based Thresholding: If You Have Individual-Based Data
...
jointBoot %>%
  ...
  stat_compare_means(method="t.test", label.y = 6.2, size=3.2)+   # label positions may need adjustment for your data
...
glimpse(BootCombinations_cutoff)
